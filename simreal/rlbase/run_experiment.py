...
from simreal.utils import yaml_dump
from simreal.utils import ask_yes_or_no
from simreal.utils import timeit
from simreal.utils import color_str
from simreal.utils import CloudpickleWrapper


@timeit(color='green', bold=True)
def run_experiment(run, config, args, seeds, log_dir, max_workers, chunksize=1, use_gpu=False, gpu_ids=None):
    ...
    def _run(job):
        ...
        result = run(config, seed, device, logdir, args)
