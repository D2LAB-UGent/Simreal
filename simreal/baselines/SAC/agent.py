...
class Agent(BaseAgent):
    ...
    def learn(self, D, **kwargs):
        ...
        logprob_vals = []
        for i in range(T):
            observations, actions, rewards, next_observations, masks, params = replay.sample(self.config['replay.batch_size'])
    ...
    def checkpoint(self, logdir, num_iter):
        ...
        torch.save(self.actor, logdir/f'model_agent_{num_iter}.pt')
